...
enum IDate { the20240512Z00 }

final iDateValues = EnumValues({"20240512Z00": IDate.the20240512Z00});
...
final iconValues = EnumValues({
  "cloudy1_night.png": IconWeather.cloudy1NightPng,
  "cloudy1.png": IconWeather.cloudy1Png,
  "cloudy2_night.png": IconWeather.cloudy2NightPng,
  "cloudy2.png": IconWeather.cloudy2Png,
  "cloudy4_night.png": IconWeather.cloudy4NightPng,
  "cloudy4.png": IconWeather.cloudy4Png,
  "cloudy5_night.png": IconWeather.cloudy5NightPng,
  "cloudy5.png": IconWeather.cloudy5Png,
  "shower1_night.png": IconWeather.shower1NightPng,
  "sunny_night.png": IconWeather.sunnyNightPng,
  "sunny.png": IconWeather.sunnyPng
});
...
enum En { clear, cloudy, covered, partlyCloudy, showers, veryCloudy }

final enValues = EnumValues({
  "Clear": En.clear,
  "Cloudy": En.cloudy,
  "Covered": En.covered,
  "Partly Cloudy": En.partlyCloudy,
  "Showers": En.showers,
  "Very Cloudy": En.veryCloudy
});

enum It { coperto, moltoNuvoloso, nuvoloso, pocoNuvoloso, rovesci, sereno }

final itValues = EnumValues({
  "Coperto": It.coperto,
  "Molto nuvoloso": It.moltoNuvoloso,
  "Nuvoloso": It.nuvoloso,
  "Poco nuvoloso": It.pocoNuvoloso,
  "Rovesci": It.rovesci,
  "Sereno": It.sereno
});
