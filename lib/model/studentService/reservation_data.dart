  ...
  factory ReservationInfo.fromJson(Map<String, dynamic> json) =>
      ReservationInfo(
        ...
        tipoApp: tipoAppValues.map[json["tipoApp"]] ??
            TipoApp.appelloConFirmaDigitaleRemota, // Default value
...
enum EdificioDes { centroDirezionale, empty, tramiteMicrosoftTeams }

final edificioDesValues = EnumValues({
  "CENTRO DIREZIONALE": EdificioDes.centroDirezionale,
  "": EdificioDes.empty,
  "TRAMITE MICROSOFT TEAMS": EdificioDes.tramiteMicrosoftTeams
});
...
enum TipoApp { appelloConFirmaDigitaleRemota, provaSenzaVerbalizzazione }

final tipoAppValues = EnumValues({
  "Appello con Firma Digitale Remota":
      TipoApp.appelloConFirmaDigitaleRemota,
  "Prova senza verbalizzazione": TipoApp.provaSenzaVerbalizzazione
});
