...
void setupServiceLocator() {
  ...
  getIt.registerLazySingleton<LocalGradesService>(() => LocalGradesService());
  getIt.registerLazySingleton<NotificationService>(() => NotificationService());
  getIt.registerLazySingleton<GradeSyncService>(
    () => GradeSyncService(
      localGradesService: getIt<LocalGradesService>(),
