...
class ProfessorUtils {
  ...
  static Future<SessionProfessorInfo?> professorSession(
    ...
    try {
      ...
      professorDataProvider.setProfessorSession(session);
  ...
  static Future<DetailsCourseInfo?> detailsCourseProfessor(
    ...
    try {
      ...
      professorDataProvider.setDetailsCourseProfessor(session);
  ...
  static Future<void> checkExamInfoProfessor(
    ...
    try {
      ...
      professorDataProvider.setAllExamInfoProfessor(session);
    } catch (_) {
      return;
    }
  }
  ...
  static Future<void> allStudentListExam(
    ...
    try {
      ...
      professorDataProvider.setAllStudentListExam(session);
    } catch (_) {
      return;
    }
  }
