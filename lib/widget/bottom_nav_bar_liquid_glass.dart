...
class BottomNavBarLiquidGlassComponent extends StatelessWidget {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  Colors.white.withValues(alpha: 0.02), // Ultra trasparente
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  Colors.white.withValues(alpha: 0.75), // Molto più trasparente
  ...
  Widget _buildMenuItem(
    ...
    return Material(
      ...
      child: InkWell(
        onTap: onTap,
        splashColor: displayIconColor.withValues(alpha: 0.05),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      displayIconColor.withValues(alpha: 0.10),
                      displayIconColor.withValues(alpha: 0.06),
                    ],
                  ),
